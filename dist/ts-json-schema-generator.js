...
const args = commander
    ...
    .parse(process.argv);
const config = Object.assign({}, Config_1.DEFAULT_CONFIG, { path: args.path, type: args.type, expose: args.expose, topRef: args.topRef, jsDoc: args.jsDoc, sortProps: !args.unstable, typeFile: args.typeFile, skipTypeCheck: !args.typeCheck });
try {
